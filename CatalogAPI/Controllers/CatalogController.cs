...
namespace CatalogAPI.Controllers
{
    ...
    public class CatalogController : ControllerBase
    {
        ...
        public ActionResult<CatalogItem> AddProduct()
        {
            ...
            var imageName = SaveImageToCloudoAsync(Request.Form.Files[0]).GetAwaiter().GetResult();
        ...
        [NonAction]
        private async Task<string> SaveImageToCloudoAsync(IFormFile image)
        {
            var imageName = $"{Guid.NewGuid()}_{image.FileName}";
            ...
            // Rename the file name by using move function
